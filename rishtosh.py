...
class Hospital:
    ...
    def Input(self):
        ...
        self.sex=input("Enter Patient's Sex (Male/Female):")
...
def ModiHospital(b,n):#to modify details
    fin=open("Hospital1.DAT","rb")
...
while True:
    ...
    if ch==1:
        ...
        n=input("PLEASE ENTER DOCTOR'S NAME TO SEARCH:--")
        SearchDoctor(n)
    elif ch==10:
        ...
        m=input("ENTER PATIENT'S SERIAL NUMBER :--")
        print ("\n")
        print ("____________________________________________ " )
